        ...
        items.forEach(item => {
            ...
            slide.innerHTML = `
                <div class="bg-white overflow-hidden border border-gray-200">
                    <div class="relative community-image-container bg-gray-200 flex items-center justify-center">
                        <img src="${item.imageUrl}" alt="${item.description.substring(0, 50)}" class="h-48 w-auto mx-auto">
